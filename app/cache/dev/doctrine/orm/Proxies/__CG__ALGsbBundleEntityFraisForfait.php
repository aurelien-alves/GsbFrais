 ...
 */
class FraisForfait extends \AL\GsbBundle\Entity\FraisForfait implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AL\\GsbBundle\\Entity\\FraisForfait' . "\0" . 'id', '' . "\0" . 'AL\\GsbBundle\\Entity\\FraisForfait' . "\0" . 'libelle', '' . "\0" . 'AL\\GsbBundle\\Entity\\FraisForfait' . "\0" . 'montant');
        }
